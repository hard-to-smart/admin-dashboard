...
const ResetPassword2 = () => {
    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto  w-[700px]">
        ...
        <div class="w-full p-6 bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md dark:bg-gray-800 dark:border-gray-700 sm:p-8">
            ...
            <form class="mt-4 space-y-4 lg:mt-5 md:space-y-5" action="#">
                ...
                <Link to='/'><button type="submit" class="w-full text-white bg-primary-500 hover:bg-primary-600 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 my-4 py-2.5 text-center dark:bg--400 dark:hover:bg-primary-500 dark:focus:ring-primary-600">
