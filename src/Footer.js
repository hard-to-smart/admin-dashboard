...
const Footer = () => {
  return (
    <div className="flex flex-row py-1 bg-[#1e4d6c] text-white justify-around">
      <div className="logo">
      ...
      <div className="flex flex-wrap justify-center text-[12px] w-[400px] text-center items-center align-middle">
        <h3>Headquarters:</h3>
        <p>
